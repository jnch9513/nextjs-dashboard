    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-6 p-4 md:p-8">
      <header className="flex flex-col gap-1">
        ...
        <p className="text-pretty text-muted-foreground">
          A minimal, config-driven table wired to one endpoint. Swap{" "}
          <code className="rounded bg-muted px-1 py-0.5 font-mono text-sm">USERS_ENDPOINT</code> in{" "}
          <code className="rounded bg-muted px-1 py-0.5 font-mono text-sm">lib/simple-table/users-api.ts</code>{" "}
